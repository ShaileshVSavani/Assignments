...
const Booking = () => {
  ...
  //   const bookingId = new Date().getTime().toString(); // Create a unique booking ID
  //   const bookingData = {
  //     bookingId,
  //     userId,
  //     movieId: id,
  ...
  //     setErrorMessage("Failed to book the tickets. Please try again.");
  //   }
  // };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Also save booking to localStorage
        ...
        <Fragment>
          ...
          >
            ...
            <Paper elevation={3} sx={{ padding: 3, width: { xs: "100%", md: "45%" }, borderRadius: 2 }}>
              ...
              <div>
                {getNext7Days().map((day, index) => (
                  <Button
                    ...
                    variant={inputs.date === day.value ? "contained" : "outlined"}
              ...
              <Typography marginTop={2} fontWeight="bold">Select Time:</Typography>
              ...
              <SeatSelection
                bookedSeats={bookedSeats}
                onSeatSelect={handleSeatSelection} // Fixed prop name here
              />
